# 20200714 - H_v1.tcl - spinning up version H of model with CLM
# overland flow on
# modified from H_v0.tcl
# DETAILS:
...
# ParFlow Inputs
file copy -force "../indicator_files/C_indicator.pfb" .
puts "Inidcator file copied"
...
pfset Geom.indi_input.FileName            "C_indicator.pfb"
#
...
#-----------------------------------------------------------------------------
pfset Geom.Perm.Names                     "domain s1 s2 s3"
...
# Layers 1 through 12 (bedrock) have K = 4.99e-7 m/s
pfset Geom.s1.Perm.Type               Constant
pfset Geom.s1.Perm.Value              0.0017892072

# Layers 5-8 (weathered bedrock) K = 1e-6 m/s
pfset Geom.s2.Perm.Type               Constant
pfset Geom.s2.Perm.Value              0.0036

# Top 4 layers have K = 3.5e-5 m/s
pfset Geom.s3.Perm.Type               Constant
pfset Geom.s3.Perm.Value              0.126


pfset Perm.TensorType                     TensorByGeom
pfset Geom.Perm.TensorByGeom.Names        "domain"
pfset Geom.domain.Perm.TensorValX         1.22169
pfset Geom.domain.Perm.TensorValY         1.22169
pfset Geom.domain.Perm.TensorValZ         0.122169
...
pfset TimingInfo.StopTime                 87648.0
pfset TimingInfo.DumpInterval             168.0
...
# Lower layers have lower porosity representing bedrock
pfset Geom.s1.Porosity.Type    Constant
pfset Geom.s1.Porosity.Value   0.05

# Middle-upper soil layers have higher porosity
pfset Geom.s2.Porosity.Type    Constant
pfset Geom.s2.Porosity.Value   0.20

# Upper soil layers have higher porosity
pfset Geom.s3.Porosity.Type    Constant
pfset Geom.s3.Porosity.Value   0.30
...
pfset Geom.domain.ICPressure.FileName				H_v0.out.press.00072.pfb
...
pfset ComputationalGrid.NZ                20
pfdist H_v0.out.press.00072.pfb

# pfset ComputationalGrid.NX                91
# pfset ComputationalGrid.NY                70
# pfset ComputationalGrid.NZ                20
pfdist C_indicator.pfb
