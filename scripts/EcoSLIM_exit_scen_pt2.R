...
load("~/research/outputs/Scenario_A/A_v6/exited_particles_A.Rda")
load("~/research/outputs/Scenario_B/B_v5/exited_particles_B.Rda")
load("~/research/outputs/Scenario_C/C_v5/exited_particles_C.Rda")
...
load(file="~/research/outputs/Scenario_A/A_v5/wt_A_v5_991.df.Rda")
...
load(file="~/research/outputs/Scenario_B/B_v4/wt_B_v4_1037.df.Rda")
...
load(file="~/research/outputs/Scenario_C/C_v4/wt_C_v4_1036.df.Rda")
...
load(file="~/research/outputs/Scenario_F/F_v1/wt_F_v1_997.df.Rda")
...
lmres_F$coefficients[2]/1000
summary(lmres_F)$r.squared
